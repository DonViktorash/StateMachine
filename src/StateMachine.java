...
/*
Добалвение нескольких возможных переходов в таблицу переходов
@param from исходное состояние
...
сопоставление с регулярным выражением не может быть осуществлено ддля такого входного символа
 */
    ...
    @param str строка
    @param from индекс в строке, с котрого начинается сопоставление
    @return -1 если подстрока начиная с позиции from не сопоставлена с
    регулярным выражением; неотрицательное значение, если подстрока сопоставлена
    с регулярным выражением - индекс в строке символа, следующего за сопоставленной подстрокой
     */
